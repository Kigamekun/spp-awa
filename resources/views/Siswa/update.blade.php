                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-6 form-group mb-3">
                                        ...
                                        <select required="" name="id_kelas" id="id_kelas"
                                            ...
                                            @foreach (DB::table('kelas')->get() as $row)
                                            <option value="{{ $row->id_kelas }}" @if ($data->id_kelas == $row->id_kelas) selected @endif>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-6 form-group mb-3">
                                            ...
                                            <input type="text" class="form-control" name="no_telp" id="nama"
                                                placeholder="no_telp" value="{{$data->no_telp}}">
                                        </div>
                                    </div>
